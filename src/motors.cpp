...
MotorClass motor_1(
  M1_PWM_PIN, M1_PWM_TIM, M1_PWM_TIM_CH, M1_ILIM, M1A_IN, M1B_IN, M1_ENC_TIM, M1_ENC_A, M1_ENC_B,
  M1_DEFAULT_DIR, &timebase_timer);
MotorClass motor_2(
  M2_PWM_PIN, M2_PWM_TIM, M2_PWM_TIM_CH, M2_ILIM, M2A_IN, M2B_IN, M2_ENC_TIM, M2_ENC_A, M2_ENC_B,
  M2_DEFAULT_DIR, &timebase_timer);
MotorClass motor_3(
  M3_PWM_PIN, M3_PWM_TIM, M3_PWM_TIM_CH, M3_ILIM, M3A_IN, M3B_IN, M3_ENC_TIM, M3_ENC_A, M3_ENC_B,
  M3_DEFAULT_DIR, &timebase_timer);
MotorClass motor_4(
  M4_PWM_PIN, M4_PWM_TIM, M4_PWM_TIM_CH, M4_ILIM, M4A_IN, M4B_IN, M4_ENC_TIM, M4_ENC_A, M4_ENC_B,
...
{
  if (arg_current_mode = MAX_CURRENT) digitalWrite(this->ilim_pin_, HIGH);
  if (arg_current_mode = REDUCED_CURRENT) digitalWrite(this->ilim_pin_, LOW);
}
